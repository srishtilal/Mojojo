...
public class DoctorMainActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position){
            case 0:
                ...
                break;
            case 1:
                setFragment(1, Settings.class);
                break;
            case 2:
                setFragment(2, logout.class);
                break;
        }
    }
