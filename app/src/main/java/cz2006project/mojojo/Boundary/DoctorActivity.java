...
public class DoctorActivity extends ActionBarActivity {
    ...
    String TITLES[] = {"Appointments","Medical Records","My Account","Log Out",};
     ...
     *//*
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DoctorActivity.this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
                ...
                switch (position) {
                    ...
                    default:
                        ...
                        break;
                    case 2:
                        if (DEBUG) Log.d(TAG, "medicalrecords fragment");
                        mTitle = "Medical Records";
                        fragmentManager.beginTransaction()
